 ...
 *
 **/
inline RC_t RTE_SC_EVENT_init( SC_EVENT_t * const signal )
{                                                                                                                      

   RC_t ret = RC_SUCCESS;

   //Set value and raw value
   signal->value  = SC_EVENT_INIT_DATA;
   signal->age    = 0;
 ...
 *
 * @param  SC_EVENT_t * const signal: Pointer to the signal object
 * @return sc_event_data_t*: pointer to the current value of the application data buffer
 *
 **/
inline SC_EVENT_data_t* RTE_SC_EVENT_getPtr( SC_EVENT_t * const signal )
{               
