...
/**
 *  file    SC_DISPLAYDATA_signal.h
 *
 *  brief   signal base class for signal sc_displaydata
 *
...
#ifndef SC_DISPLAYDATA_SIGNAL_H_INCLUDED
#define SC_DISPLAYDATA_SIGNAL_H_INCLUDED
 ...
 *  I-Port
 */
typedef RC_t (*SC_DISPLAYDATA_driverIn_t)(SC_DISPLAYDATA_data_t * const);

/**
 *  Definition of function types for driver interfaces.
 *  O-Port
 */
typedef RC_t (*SC_DISPLAYDATA_driverOut_t)( const SC_DISPLAYDATA_data_t * const);
...
/**
 * Instances of the struct SC_DISPLAYDATA_cfg_t represent the signal object configuration.
 */
struct SC_DISPLAYDATA_cfg_s
{
    /**
     * Function pointer to the input driver
     */
    SC_DISPLAYDATA_driverIn_t const inDriver;

    /**
     * Function pointer to the output driver table
     */
   SC_DISPLAYDATA_driverOut_t const outDriver;
...
typedef const struct SC_DISPLAYDATA_cfg_s SC_DISPLAYDATA_cfg_t;
...
{                                                                                                                      
     ...
     */
	const SC_DISPLAYDATA_cfg_t * const    pSigCfg;

};                                                                                                                     
typedef struct SC_DISPLAYDATA_s SC_DISPLAYDATA_t;
 ...
 *
 * @param  SC_DISPLAYDATA_t * const signal: Pointer to the signal object which will be initialised
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_DISPLAYDATA_init( SC_DISPLAYDATA_t * const signal )
{                                                                                                                      

   RC_t ret = RC_SUCCESS;

   //Set value and raw value
   signal->value  = SC_DISPLAYDATA_INIT_DATA;
   signal->age    = 0;
 ...
 *
 * @param  SC_DISPLAYDATA_t * const signal: Pointer to the signal object
 * @return  sig_status_t: The current signal status
 *
 **/
inline RTE_signalStatus_t RTE_SC_DISPLAYDATA_getStatus( const SC_DISPLAYDATA_t * const signal )
{
 ...
 *
 */
inline RC_t RTE_SC_DISPLAYDATA_setStatus( SC_DISPLAYDATA_t * const signal, const RTE_signalStatus_t status )
{
 ...
 */
inline uint32_t RTE_SC_DISPLAYDATA_getAge( const SC_DISPLAYDATA_t * const signal )
{
   return signal->age;
}
 ...
 * @return void
 */
inline void RTE_SC_DISPLAYDATA_incAge(  SC_DISPLAYDATA_t * const signal , uint32_t increment)
{
	   //Hack....
 ...
 *
 * @param  SC_DISPLAYDATA_t * const signal: Pointer to the signal object
 * @return sc_displaydata_data_t*: pointer to the current value of the application data buffer
 *
 **/
inline SC_DISPLAYDATA_data_t* RTE_SC_DISPLAYDATA_getPtr( SC_DISPLAYDATA_t * const signal )
{               
 ...
 *
 * @param  SC_DISPLAYDATA_t * const signal: Pointer to the signal object
 * @return sc_displaydata_data_t: current value of the application data buffer
 *
 **/
inline SC_DISPLAYDATA_data_t RTE_SC_DISPLAYDATA_get( const SC_DISPLAYDATA_t * const signal )
{               
   //Todo: Critical region cannot be protected using return values																						
   return signal->value;                                                                                               
}                                                                                                                      
 ...
 *
 * @param  SC_DISPLAYDATA_t * const signal: Pointer to the signal object
 * @param  SC_DISPLAYDATA_data_t* data: Pointer to the return data Pointer to the signal object
 * @return RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_DISPLAYDATA_getThreadSafe( const SC_DISPLAYDATA_t * const signal, SC_DISPLAYDATA_data_t * const data )
{    
 ...
 *
 * @param  SC_DISPLAYDATA_t * const signal: Pointer to the signal object
 * @param  sc_displaydata_data_t const value: value for the application data buffer
 * @return RC_t: standard return code, currently only RC_SUCCESS
 *
 **/
inline RC_t RTE_SC_DISPLAYDATA_set(SC_DISPLAYDATA_t * const signal, const SC_DISPLAYDATA_data_t value  )
{
 ...
 *
 */
inline RC_t RTE_SC_DISPLAYDATA_pullPort( SC_DISPLAYDATA_t * const signal )
{                                                                                                                      
   RC_t ret = RC_SUCCESS;
   ...
   {
	  SC_DISPLAYDATA_data_t value = signal->value;
      ret = signal->pSigCfg->inDriver(&value);
                                                                                                                       
      if ( ret == RC_SUCCESS )                                                                                         
      {
    	  //Critical Section
    	  RTE_SC_DISPLAYDATA_set(signal, value);
      }
      else
      {
		  //Signal is invalid. Error event (if present) will be fired
		  RTE_SC_DISPLAYDATA_setStatus(signal, RTE_SIGNALSTATUS_INVALID);
      }
 ...
 *
 **/
inline RC_t RTE_SC_DISPLAYDATA_pushPort( const SC_DISPLAYDATA_t * const signal )
{                                                                                                                      
   RC_t ret = RC_ERROR;
