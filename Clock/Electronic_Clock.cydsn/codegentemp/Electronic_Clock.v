// ======================================================================
// Electronic_Clock.v generated from TopDesign.cysch
// 06/02/2025 at 21:47
...
module SPI_Master_v2_50_2 (
	...
	cy_clock_v1_0
		#(.id("7cf02ec8-0b61-4fa7-bcde-34ab344a9abf/426fcbe0-714d-4404-8fa8-581ff40c30f1"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("327cc1a1-3988-4840-bffb-c012973a0786"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("de3d7c44-348a-4242-81df-ba6b50172c2a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d9ff8efe-3a21-4727-9557-91f660fb4182"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    UART_v2_50_0 UART_LOG (
        ...
        .rx_clk(Net_274),
        .rx_data(Net_275),
        .rx_interrupt(Net_276),
        .tx(Net_277),
        .tx_clk(Net_278),
        .tx_data(Net_279),
        .tx_en(Net_280),
        .tx_interrupt(Net_281));
	...
	cy_clock_v1_0
		#(.id("00d9b9fc-fa0b-42ff-a43c-91edd81faa23"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("200000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("26c56878-e0c7-4687-9a15-9db122473e46"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    SPI_Master_v2_50_2 TFT_SPI (
        .clock(1'b0),
        .miso(Net_192),
        .mosi(Net_232),
        .reset(1'b0),
        .rx_interrupt(Net_225),
        .sclk(Net_235),
        .sdat(Net_226),
        .ss(Net_227),
        .tx_interrupt(Net_228));
	...
	cy_psoc3_pins_v1_10
		#(.id("f1ce938c-0ba8-4de9-8fc9-8b8619bf4194"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("65865094-40a3-4cff-a782-233aed64763a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4d0dbafe-d5d7-4b4f-8504-121301ab8eaa"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("60b66a39-9259-4af7-83f3-8fc4620fb444"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("65a8a0c9-1251-4bed-adcb-0e2f6762e102"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
